...
local J= function(player)
	if not player:HasTag("playerghost") and player.prefab == "totooria" then
		if player.jinengdian == 0 then
			player.components.talker:Say(ttrstrs[17]..ttrstrs[18]..(player.dengji).."\n"..ttrstrs[19]..(100*player.xingyun)..ttrstrs[20].."\n"..ttrstrs[21]..(5*player.gongjili)..ttrstrs[20].."\n"..ttrstrs[22]..(2.5*player.sudu)..ttrstrs[20].."\n"..ttrstrs[23]..(6.25*player.xueliang))
		else
			player.components.talker:Say(ttrstrs[17]..ttrstrs[18]..(player.dengji).."\n"..ttrstrs[34]..(player.jinengdian).."\n"..ttrstrs[19]..(100*player.xingyun)..ttrstrs[20].."\n"..ttrstrs[21]..(5*player.gongjili)..ttrstrs[20].."\n"..ttrstrs[22]..(2.5*player.sudu)..ttrstrs[20].."\n"..ttrstrs[23]..(6.25*player.xueliang))
	    end
    end
end
...
local K = function(player)
	if not player:HasTag("playerghost") and player.prefab == "totooria" then
		player.components.talker:Say(ttrstrs[6]..(player.jinengdian)..ttrstrs[7].."\n"..ttrstrs[30].."\n"..ttrstrs[31].."\n"..ttrstrs[32].."\n"..ttrstrs[33])
	end
end
